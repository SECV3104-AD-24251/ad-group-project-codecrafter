...
<div class="container">
    ...
    <!-- Navigation Bar -->
    <div class="nav">
        <a href="{{ route('student.dashboard') }}" class="active"><i class="fas fa-home"></i>Dashboard</a>
        <a href="{{ route('student.courses.registered') }}"><i class="fas fa-book"></i>Course Registered</a>
    </div>
