...
<body>
    ...
    <div class="container">
        ...
        <div class="filter-section">
            <label>
                <input type="checkbox" id="allPrograms" onchange="toggleAllPrograms(this)" <?php if(in_array('ALL', $selectedPrograms ?? ['ALL'])): ?> checked <?php endif; ?>>
                ALL
            </label>
...
<?php /**PATH C:\xampp\Laravel\StudentReg - ZF\resources\views/student/courseRegistration.blade.php ENDPATH**/ ?>