...
<div class="container">
    ...
    <div class="container">
        ...
        <?php elseif(session('error')): ?>
            <p class="message" style="color: red;"><?php echo e(session('error')); ?></p>
        <?php endif; ?>

        <?php if($registeredSections->isEmpty()): ?>
    <div id="popupModal" class="modal">
        <div class="modal-content">
            <span class="close-button" onclick="closeModal()">&times;</span>
            <h3>Registration Required</h3>
            <p>You have not registered for any courses yet. Please register for courses.</p>
            <a href="<?php echo e(route('student.courses.register')); ?>" class="back-button">Go to Course Registration</a>
        </div>
    </div>
...
<?php endif; ?>
            ...
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $registeredSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><?php echo e($section->course->subject_code); ?></td>
                            <td><?php echo e($section->course->subject_name); ?></td>
                            ...
                            <td>
                                ...
                                <form method="POST" action="<?php echo e(route('processRegistration.enroll')); ?>">
                                    ...
                                    <input type="hidden" name="course_id" value="<?php echo e($section->course_id); ?>">
        ...
        <br>
        <!-- Back Button -->
        <a href="<?php echo e(route('student.courses.register')); ?>" class="back-button" style="margin-top: 10px;">Go Back to Course Registration</a>
    </div>
</body>

</html>
<?php /**PATH C:\xampp\Laravel\StudentReg - ZF\resources\views/student/studentCourseRegistered.blade.php ENDPATH**/ ?>